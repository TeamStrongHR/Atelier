...
export default function OutfitCard (props) {
  ...
  return (
    <div className='outfit-card'>
      ...
      <img className='card-image' src={props.outfit.default_style[0].photos[0].url} alt={props.outfit.name} ></img>
      <div className='card-info'>
        <i className='card-category'>{props.outfit.category}</i>
        <b className='card-name'>{props.outfit.name}</b>
        <Price original_price={props.outfit.default_style[0].original_price} sale_price={props.outfit.default_style[0].sale_price}/>
        <small className='card-stars'>
          <StarRating rating={props.outfit.ratings}/>
        </small>
      </div>
